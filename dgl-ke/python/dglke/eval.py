...
from utils import get_compatible_batch_size, create_dicts
...
def main():
    ...
    if not args.negative_sampling_for_hetero:
        neg_eval_head_d, neg_eval_tail_d = None, None

    if args.neg_sample_size_eval < 0:
        #args.neg_sample_size_eval = args.neg_sample_size = eval_dataset.g.number_of_nodes()
        args.neg_sample_size_eval = args.neg_sample_size = len(nid_s2p)
    ...
    if args.num_proc > 1:
        ...
        test(args, model, [test_sampler_head, test_sampler_tail], nt_idx=nid_s2p)
